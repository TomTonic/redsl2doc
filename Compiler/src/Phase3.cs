    ...
    public static class Phase3
    {
        ...
        private static void ResolvePackage(XElement node)
        {
            ...
            else
            {
                ...
                {
                    node.SetAttributeValue("package", "General Requirements");
                }
            }
        }
        ...
        public static XDocument TidyPackageDeclarations(XDocument doc)
        {
            ...
            GatherRequirementDeclarationsInNewPackageNodes(result, packageNames);
            return result;
        }

        private static void GatherRequirementDeclarationsInNewPackageNodes(XDocument result, IEnumerable<string> packageNames)
        {
